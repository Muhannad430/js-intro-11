...
let author = new Author('George R. R.', 'Martin', 'United States', [ book1, book2, book3 ]);
...
/*
forEach() method
author.getBooks().array.forEach(book => console.log(book));
*/

let bookwithMorePage = author.getBooks().reduce((acc, curr) => curr.page > acc.page ? curr : acc);

console.log(bookwithMorePage.title);